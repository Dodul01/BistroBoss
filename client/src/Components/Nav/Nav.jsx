...
const Nav = () => {
    ...
    const link = <>
        ...
        <Link className="flex gap-2 py-2 px-3 text-[#D99904] rounded md:bg-transparent hover:text-[#EEFF25] transition-all md:p-0 " to="/dashbord/cart"><BsCart4 className='text-2xl' /> <span>{cart?.length}</span></Link>
        {
            user ?
